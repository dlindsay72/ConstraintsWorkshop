...
class ViewController: NSViewController {
    ...
    func createVFL() {
        ...
        let textFields = ["view0" : makeView(0), "view1" : makeView(1), "view2" : makeView(2), "view3" : makeView(3)]
    ...
    func createAnchors() {
        ...
        //create four views and put them in an array
    ...
    func createGridView() {
        ...
        //mark that we will create our own constraints
